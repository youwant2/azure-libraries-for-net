...
namespace Microsoft.Azure.Management.Storage.Fluent.Models
{
    ...
    public partial class FileShareInner : AzureEntityResourceInner
    {
        /// <summary>
        /// Initializes a new instance of the FileShareInner class.
        /// </summary>
        ...
        /// (5120).</param>
        public FileShareInner(string id = default(string), string name = default(string), string type = default(string), string etag = default(string), System.DateTime? lastModifiedTime = default(System.DateTime?), IDictionary<string, string> metadata = default(IDictionary<string, string>), int? shareQuota = default(int?))
