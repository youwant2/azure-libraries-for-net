...
namespace Microsoft.Azure.Management.Storage.Fluent.Models
{
    ...
    public partial class SkuInformation
    {
        ...
        public SkuInformation(SkuName name, SkuTier? tier = default(SkuTier?), string resourceType = default(string), Kind kind = default(Kind), IList<string> locations = default(IList<string>), IList<SKUCapability> capabilities = default(IList<SKUCapability>), IList<Restriction> restrictions = default(IList<Restriction>))
        {
            Name = name;
            Tier = tier;
