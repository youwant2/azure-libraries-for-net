...
namespace Microsoft.Azure.Management.Storage.Fluent.Models
{
    ...
    public partial class RoutingPreference
    {
        ...
        /// published</param>
        public RoutingPreference(RoutingChoice routingChoice = default(RoutingChoice), bool? publishMicrosoftEndpoints = default(bool?), bool? publishInternetEndpoints = default(bool?))
        {
