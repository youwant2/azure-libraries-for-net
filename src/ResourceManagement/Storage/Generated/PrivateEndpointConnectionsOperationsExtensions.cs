...
namespace Microsoft.Azure.Management.Storage.Fluent
{
    ...
    public static partial class PrivateEndpointConnectionsOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<PrivateEndpointConnectionInner> GetAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string accountName, string privateEndpointConnectionName, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PrivateEndpointConnectionInner> PutAsync(this IPrivateEndpointConnectionsOperations operations, string resourceGroupName, string accountName, string privateEndpointConnectionName, PrivateEndpointConnectionInner properties, CancellationToken cancellationToken = default(CancellationToken))
            {
