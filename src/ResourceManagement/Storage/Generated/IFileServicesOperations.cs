...
namespace Microsoft.Azure.Management.Storage.Fluent
{
    ...
    public partial interface IFileServicesOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<FileServiceItemsInner>> ListWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<FileServicePropertiesInner>> GetServicePropertiesWithHttpMessagesAsync(string resourceGroupName, string accountName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
