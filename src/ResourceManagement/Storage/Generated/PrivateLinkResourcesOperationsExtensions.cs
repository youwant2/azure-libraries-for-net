...
namespace Microsoft.Azure.Management.Storage.Fluent
{
    ...
    public static partial class PrivateLinkResourcesOperationsExtensions
    {
            ...
            /// </param>
            public static async Task<PrivateLinkResourceListResultInner> ListByStorageAccountAsync(this IPrivateLinkResourcesOperations operations, string resourceGroupName, string accountName, CancellationToken cancellationToken = default(CancellationToken))
            {
