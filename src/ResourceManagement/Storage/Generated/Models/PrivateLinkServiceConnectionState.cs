...
namespace Microsoft.Azure.Management.Storage.Fluent.Models
{
    ...
    public partial class PrivateLinkServiceConnectionState
    {
        ...
        public PrivateLinkServiceConnectionState(PrivateEndpointServiceConnectionStatus status = default(PrivateEndpointServiceConnectionStatus), string description = default(string), string actionRequired = default(string))
        {
            Status = status;
